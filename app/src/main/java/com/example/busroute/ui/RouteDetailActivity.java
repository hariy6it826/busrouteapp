...
public class RouteDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ImageView accessibilityView = findViewById(R.id.accessibility);
        if(selectedRoute.getAccessible().equals("true")){
            accessibilityView.setVisibility(View.VISIBLE);
        }else{
            accessibilityView.setVisibility(View.GONE);
        }
